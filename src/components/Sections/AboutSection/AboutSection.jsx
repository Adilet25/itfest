      ...
      <div className="expoAbout">
        <div className="expoAbout_div exp1">
          ...
          <p>
            ...
            <br />
            Способствование ускоренномувнедрению новейших технологий, таких как
            искусственный интеллект,блокчейн, интернет вещей и
            кибербезопасность, для улучшения жизнии экономического роста в
            Кыргызстане.
          </p>
          <p>
            <span className="expTextBold">
            ...
            <br />
            Обеспечение доступа к образовательным программам, которыепомогают
            развивать профессиональные навыки и подготавливаютспециалистов к
          ...
          <p>
            ...
            вдохновление на создание новых решений итехнологий, способных
        ...
        <div className="expoAbout_div exp2">
          ...
          <p>
            ...
            способствующимразвитию технологического потенциала Кыргызстана. Мы
            стремимся укрепитьэкосистему информационных технологий, поддержать
